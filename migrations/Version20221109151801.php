 ...
 */
final class Version20221109151801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(200) DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, link LONGTEXT DEFAULT NULL, clan VARCHAR(50) DEFAULT NULL, age_status VARCHAR(50) DEFAULT NULL, is_validate TINYINT(1) DEFAULT NULL, recognized LONGTEXT DEFAULT NULL, INDEX IDX_937AB034A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
